...
// One pending (or recently-resolved) approval. Shared between the Approvals
...
import { RISK_CLASS, RISK_LABEL, approvalTitle, waitedFor } from "@/lib/approvals";
